        ...
        <section className="bg-gray-200 text-black my-12 mx-5">
            <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                ...
                <div className="space-y-4">
                    <details className="w-full border-white border-2 rounded-lg text-left">
                    ...
                    <details className="w-full border-2 rounded-lg border-white text-xl text-left">
                    ...
                    <details className="w-full border-2 border-white rounded-lg text-left">
